...
const PARTY_CHALLENGES = [
  "🎯 Normal: Di una palabra y un número.",
  "🤐 Mimo: Haz gestos, prohibido hablar (gesticula el número también).",
  "🎨 Dibujo: Dibuja la pista en 10 segundos (dibuja el número también).",
...
export const getRandomChallenge = () => {
  return PARTY_CHALLENGES[Math.floor(Math.random() * PARTY_CHALLENGES.length)];
};